...
const roles = [
  {
    ...
    tag: 'Mobile App',
    tagColor: 'text-amber',
    description: 'Residents and visitors report incidents in under 30 seconds. No training needed. Track your report status live as marshals respond.',
    bullets: [
  ...
  },
  {
    ...
    cta: { label: 'Register as Marshal →', to: '/register', style: 'outline-blue' as const },
  },
  {
    id: 'commander',
    bg: 'bg-slate-900',
    ...
    description: 'City leadership gets a real-time operational view of every incident, every marshal, and every zone — in one command dashboard.',
    bullets: [
      'Live incident feed across all 10 zones',
      'Marshal positions and availability',
