  ...
  return (
    <div className="space-y-6 p-4">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-lg font-semibold text-[#0F172A]">Report Detail</h1>
      ...
      <div className="rounded-lg border border-border p-4">
        <p className="mb-2 text-xs font-medium uppercase tracking-wide text-[#64748B]">Location</p>
        {incident.locationLat ? (
          <div className="space-y-2">
            <p className="flex items-center gap-2 text-sm text-[#0F172A]">
          ...
          <p className="text-sm text-[#94A3B8]">No location data</p>
        )}
      </div>
